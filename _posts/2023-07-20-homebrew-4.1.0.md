...
- [`brew fetch`, `brew --cache`, `brew audit`](https://github.com/Homebrew/brew/pull/15225) and [`brew readall`](https://github.com/Homebrew/brew/pull/15470) have `--os` and `--arch` flags to simulate different operating systems and CPU architectures.
