...
- [`brew postgresql-upgrade-database` is deprecated.](https://github.com/Homebrew/brew/pull/15799)
  It is no longer needed now that we use versioned `postgresql` formulae.
...
- [`brew list --full-names` properly outputs Homebrew organisation names for casks.](https://github.com/Homebrew/brew/pull/16328)
...
- [Formulae support `ENV.O3` again to allow passing `-O3` compiler optimisations.](https://github.com/Homebrew/brew/pull/15680)
