...
- [`HOMEBREW_DOCKER_REGISTRY_TOKEN_BASIC` allows authenticating with a Docker registry proxying GitHub Packages using a basic authentication token.](https://github.com/Homebrew/brew/pull/12673)
...
- [Homebrew has begun the process to leave the SFC](https://github.com/Homebrew/brew/pull/12532) and is [moving to Open Collective](https://opencollective.com/homebrew). This allows more permissive spending of our funds in exchange for our incomings/outgoings being public.
