...
Today I'd like to announce Homebrew 1.1.0. We've had a great response to Homebrew 1.0.0 and been iterating on our work there. That 1.1.0 follows 1.0.9 is a happy coincidence due to breaking changes; in the future we may have e.g. a 1.1.10.
...
- [RuboCop is configured so RuboCop-supporting editors get the correct messaging for editing files in Homebrew/brew and `Library/Taps`](https://github.com/Homebrew/brew/pull/1128)
