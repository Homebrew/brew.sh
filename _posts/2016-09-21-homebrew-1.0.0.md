...
- [Homebrew/brew passes tests on Linux and has a generic backend for porting to other platforms in future](https://github.com/Homebrew/brew/pull/168)
...
- Use [new Ruby Macho library](https://github.com/Homebrew/ruby-macho) for reading and writing macOS Mach-O library file locations.
