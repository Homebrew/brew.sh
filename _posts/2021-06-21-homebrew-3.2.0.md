...
- [`brew leaves` has `--installed-on-request` and `--installed-as-dependency` flags to only list formulae installed manually or as dependencies.](https://github.com/Homebrew/brew/pull/11368)
...
- [`brew bottle --bottle-arch` allows bottles with custom architectures.](https://github.com/Homebrew/brew/pull/11352)
