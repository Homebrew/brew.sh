...
Today I'd like to announce Homebrew 1.7.0. The most significant changes since 1.6.0 are fixes for macOS 10.14 Mojave's developer beta, [Homebrew Formulae's](https://formulae.brew.sh) JSON analytics and formulae APIs and various formula API deprecations.
