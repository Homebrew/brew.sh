...
- [`brew bump-formula-pr` and `brew bump-cask-pr` refuse to bump packages that Homebrew's automation already handles.](https://github.com/Homebrew/brew/pull/16750)
