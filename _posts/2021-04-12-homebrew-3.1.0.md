...
- [The `HOMEBREW_NO_BOTTLE_SOURCE_FALLBACK` variable is removed (as its behaviour is now the default).](https://github.com/Homebrew/brew/pull/10640)
...
- Homebrew's Annual General Meeting in February [elected a new Project Leadership Committee and Technical Steering Committee and re-elected me (Mike McQuaid) as Project Leader](https://github.com/Homebrew/brew#who-we-are)
