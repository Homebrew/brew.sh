...
- `brew test-bot --build-dependents-from-source` [limits source builds to ten dependents per formula per shard, prioritising popular packages](https://github.com/Homebrew/brew/pull/23884), enabling [broader Linux source-build coverage](https://github.com/Homebrew/brew/pull/23910) while keeping CI runtime manageable.
- Homebrew [runs routine Golden Gate dependent tests](https://github.com/Homebrew/brew/pull/23942) on [GitHub's `xcode-27` runners](https://github.blog/changelog/2026-09-10-xcode-27-runner-image-now-runs-on-macos-27/), reducing reliance on self-hosted infrastructure.
...
- [`brew bump-compatibility-version` records changes requiring dependent rebuilds.](https://github.com/Homebrew/brew/pull/22846)
