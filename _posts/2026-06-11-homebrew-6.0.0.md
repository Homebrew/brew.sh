...
- [Homebrew clarifies `compatibility_version` guidance](https://github.com/Homebrew/brew/pull/21902) and [Homebrew/homebrew-core backfills `compatibility_version 1`](https://github.com/Homebrew/homebrew-core/pull/273379). This will help reduce the number of formulae that need to be upgraded by `brew upgrade` over time.
