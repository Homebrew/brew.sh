...
- [`deprecate!` and `disable!` in formulae with missing or non-ISO 8601 dates are deprecated.](https://github.com/Homebrew/brew/pull/9478)
...
- [Installing formulae missing bottles from the homebrew-core or linuxbrew-core taps requires specifying `--build-from-source`.](https://github.com/Homebrew/brew/pull/9518)
- [`brew livecheck` now supports casks.](https://github.com/Homebrew/brew/pull/8578)

Finally:

- [Discourse](https://github.com/Homebrew/brew/pull/9144) and [IRC](https://github.com/Homebrew/brew/pull/8981) are now deprecated as official communication methods in favour of [GitHub Discussions](https://github.com/Homebrew/brew/pull/8802). Discourse will be made read-only on January 1st 2021.
